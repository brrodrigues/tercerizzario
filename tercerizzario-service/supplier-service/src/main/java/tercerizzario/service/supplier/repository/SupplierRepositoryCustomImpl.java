...
public class SupplierRepositoryCustomImpl implements SupplierRepositoryCustom {
     ...
     */
    @Override
    public SupplierDomain upsert(SupplierDomain supplier) {
        ...
        SupplierDomain findAndModify = mongoTemplate.findAndModify(query, update, FindAndModifyOptions.options().returnNew(true), SupplierDomain.class);
